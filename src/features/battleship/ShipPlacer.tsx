    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-3">
        <button
          ...
          className="flex-1 py-3 bg-gray-100 hover:bg-gray-200 rounded-xl font-medium flex items-center justify-center gap-2 transition-all"
        >
        ...
        <button
          onClick={handleReset}
          className="flex-1 py-3 bg-red-50 hover:bg-red-100 text-red-500 rounded-xl font-medium flex items-center justify-center gap-2 transition-all"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {allShipsPlaced && (
        <button
          ...
          className="w-full py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-2xl font-bold text-lg shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
        >
