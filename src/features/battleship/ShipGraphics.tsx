  ...
  if (!isHorizontal) {
    ...
    return (
      <div className={`${className} flex items-center justify-center`}>
        ...
        >
          <defs>
            <linearGradient id="carrierGradV" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#6366f1" />
              <stop offset="100%" stopColor="#4f46e5" />
            </linearGradient>
          </defs>
          <path d="M8 6 L152 6 Q158 6 158 16 Q158 26 152 26 L8 26 Q2 26 2 16 Q2 6 8 6" fill="url(#carrierGradV)" />
    ...
    return (
      <div className={`${className} flex items-center justify-center`}>
        <svg
          viewBox="0 0 128 32"
          className="h-full"
          style={{ transform: 'rotate(90deg)', width: 'auto', maxHeight: '100%' }}
          preserveAspectRatio="xMidYMid meet"
        >
          <defs>
            <linearGradient id="battleshipGradV" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#8b5cf6" />
              <stop offset="100%" stopColor="#7c3aed" />
            </linearGradient>
          </defs>
          <path d="M6 8 L122 8 Q126 8 126 16 Q126 24 122 24 L6 24 Q2 24 2 18 L6 8" fill="url(#battleshipGradV)" />
  ...
  if (!isHorizontal) {
    return (
      <div className={`${className} flex items-center justify-center`}>
        ...
        >
          <defs>
            <linearGradient id="cruiserGradV" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#ec4899" />
              <stop offset="100%" stopColor="#db2777" />
            </linearGradient>
          </defs>
          <path d="M4 16 L12 8 L84 8 Q92 8 92 16 Q92 24 84 24 L12 24 L4 16" fill="url(#cruiserGradV)" />
  ...
  if (!isHorizontal) {
    return (
      <div className={`${className} flex items-center justify-center`}>
        ...
        >
          <defs>
            <linearGradient id="subGradV" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#14b8a6" />
              <stop offset="100%" stopColor="#0d9488" />
            </linearGradient>
          </defs>
          <ellipse cx="48" cy="18" rx="44" ry="10" fill="url(#subGradV)" />
  ...
  if (!isHorizontal) {
    return (
      <div className={`${className} flex items-center justify-center`}>
        ...
        >
          <defs>
            <linearGradient id="destroyerGradV" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#f59e0b" />
              <stop offset="100%" stopColor="#d97706" />
            </linearGradient>
          </defs>
          <path d="M4 16 L10 10 L54 10 Q60 10 60 16 Q60 22 54 22 L10 22 L4 16" fill="url(#destroyerGradV)" />
